...
# Function for 'success-pie-chart'
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # ALL sites are selected!
        # use all rows in the dataframe spacex_df to render and 
        # return a pie chart graph to show the total success launches
        ...
        # Specific launch site is selected!
        # filter the dataframe spacex_df
        # to include only data for the selected site
        ...
        # Render and return a pie chart graph to show the success and failure counts for the selected site
...
# TASK 4:
# Callback function for `site-dropdown` and 
# `payload-slider` as inputs, 
...
# Function for 'success-payload-scatter-chart'
def update_scatter_chart(entered_site, selected_payload):
    if entered_site == 'ALL':
        # If all sites selected, create scatter plot for all data
